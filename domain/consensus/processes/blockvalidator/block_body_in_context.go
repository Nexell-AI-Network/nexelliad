...
import (
	...
	"github.com/Nexell-AI-Network/nexelliad/v2/domain/consensus/utils/virtual"
...
func (v *blockValidator) checkCoinbaseSubsidy(
	...
	for _, parent := range parents {
		...
		// The pruning proof ( https://github.com/Nexell-AI-Network/docs/blob/main/Reference/prunality/Prunality.pdf ) concludes
